...
def calculate_fees(gross_pl: float, trade_size: float, fee_rate: float = 0.02) -> float:
    """
    Polymarket fee model: taker fee = 2% of trade value, charged on every trade.
    If you win $3 on a $10 trade: net = $3.00 - ($10 × 0.02) = $2.80
    If you lose $7 on a $10 trade: net = -$7.00 - ($10 × 0.02) = -$7.20
    """
